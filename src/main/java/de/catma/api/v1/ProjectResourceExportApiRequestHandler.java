...
import de.catma.api.v1.serialization.model_wrappers.ProjectExportUserPropertyDefinition;
import de.catma.api.v1.serialization.models.LegacyExport;
import de.catma.api.v1.serialization.models.LegacyExportDocument;
...
public class ProjectResourceExportApiRequestHandler implements RequestHandler {
	...
	private ProjectExportSourceDocument getPreApiSourceDocument(SourceDocument sourceDocument) throws Exception {
		int size = 0;
