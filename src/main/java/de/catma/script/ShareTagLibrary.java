...
public class ShareTagLibrary extends AbstractScript {

	
	public static void main(String[] args) {
		try {
			new ShareTagLibrary().run(args);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	private void run(String[] args) throws IOException {
		...
		String tagLibraryId = args[4];
		String accessMode = args[5];
		
		StringBuilder urlBuilder = new StringBuilder(baseURL);

		urlBuilder.append("taglibrary/share?");
		urlBuilder.append("tid="+tagLibraryId);
