...
import de.catma.ui.client.ui.visualization.doubletree.impl.DoubleTreeJsImplStandard;
...
public final class DoubleTreeJs extends JavaScriptObject {
	...
	public void setupFromArrays(
		...
		impl.setupFromArrays(this, prefix, tokens, postfix, caseSensitive, rightToLeftLanguage);
	}
