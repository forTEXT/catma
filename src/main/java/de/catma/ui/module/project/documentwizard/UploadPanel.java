...
class UploadPanel extends HorizontalLayout implements WizardStep {
	...
	public UploadPanel(ProgressStepFactory progressStepFactory) {
		this.progressStep = progressStepFactory.create(1, "Upload some documents");
