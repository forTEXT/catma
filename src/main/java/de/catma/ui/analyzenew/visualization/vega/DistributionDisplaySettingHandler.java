...
public final class DistributionDisplaySettingHandler implements DisplaySettingHandler {
	...
	private String getGroupByPhraseScript() throws IOException {
		if (groupByPhraseScript == null) {
			...
			IOUtils.copy(Thread.currentThread().getContextClassLoader().getResourceAsStream(
					"/de/catma/ui/analyzenew/visualization/vega/resources/phrase_dist_chart.json"), buffer);
	...
	private String getGroupByTagScript() throws IOException {
		if (groupByTagScript == null) {
			...
			IOUtils.copy(Thread.currentThread().getContextClassLoader().getResourceAsStream(
					"/de/catma/ui/analyzenew/visualization/vega/resources/tag_dist_chart.json"), buffer);
