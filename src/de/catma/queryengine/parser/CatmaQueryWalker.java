// $ANTLR 3.4 C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g 2014-05-30 15:24:24
...
public class CatmaQueryWalker extends TreeParser {
    ...
    // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:56:1: unionQuery returns [Query query] : ^( ND_UNION term1= term term2= term (exclusiveMarker= 'EXCL' )? ) ;
    public final Query unionQuery() throws RecognitionException {
        ...
        try {
            // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:57:2: ( ^( ND_UNION term1= term term2= term (exclusiveMarker= 'EXCL' )? ) )
            // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:57:4: ^( ND_UNION term1= term term2= term (exclusiveMarker= 'EXCL' )? )
            {
            ...
            // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:57:52: (exclusiveMarker= 'EXCL' )?
            int alt3=2;
    ...
    // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:61:1: collocQuery returns [Query query] : ^( ND_COLLOC term1= term term2= term ( INT )? (grMarker= 'GR' )? ) ;
    public final Query collocQuery() throws RecognitionException {
        Query query = null;


        CommonTree grMarker=null;
        ...
        try {
            // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:62:2: ( ^( ND_COLLOC term1= term term2= term ( INT )? (grMarker= 'GR' )? ) )
            // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:62:4: ^( ND_COLLOC term1= term term2= term ( INT )? (grMarker= 'GR' )? )
            {
            ...
            // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:62:51: (grMarker= 'GR' )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:62:51: grMarker= 'GR'
                    {
                    grMarker=(CommonTree)match(input,45,FOLLOW_45_in_collocQuery227); 
            ...
            match(input, Token.UP, null); 
             ...
             query = new CollocQuery(term1, term2, (INT8!=null?INT8.getText():null), (grMarker!=null?grMarker.getText():null)); 
    ...
    public final Query exclusionQuery() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,ND_EXCLUSION,FOLLOW_ND_EXCLUSION_in_exclusionQuery254); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_term_in_exclusionQuery258);
            term1=term();

            state._fsp--;


            pushFollow(FOLLOW_term_in_exclusionQuery262);
            term2=term();
        ...
        try {
            ...
            switch (alt8) {
                case 1 :
                    // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:110:32: tagMatchMode= TAG_MATCH_MODE
                    {
                    tagMatchMode=(CommonTree)match(input,TAG_MATCH_MODE,FOLLOW_TAG_MATCH_MODE_in_tagQuery470); 
    ...
    public final Query propertyQuery() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA13_0==ND_PROPERTY) ) {
                alt13=1;
            }
            else if ( (LA13_0==ND_TAGPROPERTY) ) {
                alt13=2;
            }
            else {
                NoViableAltException nvae =
            ...
            switch (alt13) {
                case 1 :
                    ...
                    {
                    match(input,ND_PROPERTY,FOLLOW_ND_PROPERTY_in_propertyQuery496); 
                    ...
                    switch (alt9) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_phrase_in_propertyQuery505);
                            value=phrase();
                    ...
                    switch (alt10) {
                        case 1 :
                            // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:115:62: tagMatchMode= TAG_MATCH_MODE
                            {
                            tagMatchMode=(CommonTree)match(input,TAG_MATCH_MODE,FOLLOW_TAG_MATCH_MODE_in_propertyQuery511); 
                ...
                case 2 :
                    ...
                    {
                    match(input,ND_TAGPROPERTY,FOLLOW_ND_TAGPROPERTY_in_propertyQuery521); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_phrase_in_propertyQuery525);
                    tag=phrase();
                    ...
                    switch (alt11) {
                        case 1 :
                            ...
                            {
                            pushFollow(FOLLOW_phrase_in_propertyQuery534);
                            value=phrase();
                    ...
                    switch (alt12) {
                        case 1 :
                            // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:116:76: tagMatchMode= TAG_MATCH_MODE
                            {
                            tagMatchMode=(CommonTree)match(input,TAG_MATCH_MODE,FOLLOW_TAG_MATCH_MODE_in_propertyQuery540); 
    ...
    public final Query regQuery() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,ND_REG,FOLLOW_ND_REG_in_regQuery566); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_phrase_in_regQuery568);
            phrase19=phrase();
            ...
            switch (alt14) {
                case 1 :
                    // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:121:41: caseInsensitiveMarker= 'CI'
                    {
                    caseInsensitiveMarker=(CommonTree)match(input,43,FOLLOW_43_in_regQuery572); 
        ...
        try {
            ...
            switch (alt16) {
                case 1 :
                    ...
                    {
                    match(input,ND_FREQ,FOLLOW_ND_FREQ_in_freqQuery600); 

                    match(input, Token.DOWN, null); 
                    EQUAL20=(CommonTree)match(input,EQUAL,FOLLOW_EQUAL_in_freqQuery602); 

                    rInt1=(CommonTree)match(input,INT,FOLLOW_INT_in_freqQuery606); 
                    ...
                    switch (alt15) {
                        case 1 :
                            // C:\\data\\eclipse_workspace\\catma\\grammars\\tree\\CatmaQueryWalker.g:126:35: rInt2= INT
                            {
                            rInt2=(CommonTree)match(input,INT,FOLLOW_INT_in_freqQuery610); 
                ...
                case 2 :
                    ...
                    {
                    match(input,ND_FREQ,FOLLOW_ND_FREQ_in_freqQuery621); 

                    match(input, Token.DOWN, null); 
                    UNEQUAL21=(CommonTree)match(input,UNEQUAL,FOLLOW_UNEQUAL_in_freqQuery623); 

                    INT22=(CommonTree)match(input,INT,FOLLOW_INT_in_freqQuery625); 
    ...
    public final Query similQuery() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,ND_SIMIL,FOLLOW_ND_SIMIL_in_similQuery653); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_phrase_in_similQuery655);
            phrase23=phrase();

            state._fsp--;


            INT24=(CommonTree)match(input,INT,FOLLOW_INT_in_similQuery657); 
    ...
    public final Query wildQuery() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,ND_WILD,FOLLOW_ND_WILD_in_wildQuery684); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_phrase_in_wildQuery686);
            phrase25=phrase();
    ...
    public final void refinement(Query query) throws RecognitionException {
        ...
        try {
            ...
            {
            pushFollow(FOLLOW_refinementExpression_in_refinement712);
        ...
        try {
            ...
            switch (alt17) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_orRefinement_in_refinementExpression738);
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_andRefinement_in_refinementExpression746);
                ...
                case 3 :
                    ...
                    {
                    match(input,ND_REFINE,FOLLOW_ND_REFINE_in_refinementExpression755); 

                    match(input, Token.DOWN, null); 
                    pushFollow(FOLLOW_refinementTerm_in_refinementExpression757);
    ...
    public final Refinement orRefinement() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,ND_ORREFINE,FOLLOW_ND_ORREFINE_in_orRefinement782); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_refinementTerm_in_orRefinement786);
            rTerm1=refinementTerm();

            state._fsp--;


            pushFollow(FOLLOW_refinementTerm_in_orRefinement790);
    ...
    public final Refinement andRefinement() throws RecognitionException {
        ...
        try {
            ...
            {
            match(input,ND_ANDREFINE,FOLLOW_ND_ANDREFINE_in_andRefinement820); 

            match(input, Token.DOWN, null); 
            pushFollow(FOLLOW_refinementTerm_in_andRefinement824);
            rTerm1=refinementTerm();

            state._fsp--;


            pushFollow(FOLLOW_refinementTerm_in_andRefinement828);
            rTerm2=refinementTerm();
    ...
    public final Refinement refinementTerm() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA18_0==ND_FREQ||LA18_0==ND_PROPERTY||(LA18_0 >= ND_REG && LA18_0 <= ND_TAGPROPERTY)||LA18_0==ND_WILD) ) {
                alt18=1;
            }
            else if ( (LA18_0==ND_ANDREFINE||LA18_0==ND_ORREFINE||LA18_0==ND_REFINE) ) {
                alt18=2;
            }
            else {
                NoViableAltException nvae =
            ...
            switch (alt18) {
                case 1 :
                    ...
                    {
                    pushFollow(FOLLOW_selector_in_refinementTerm858);
                    selector30=selector();
                ...
                case 2 :
                    ...
                    {
                    pushFollow(FOLLOW_refinementExpression_in_refinementTerm866);
    ...
    public static final BitSet FOLLOW_term_in_collocQuery220 = new BitSet(new long[]{0x0000200000000088L});
    public static final BitSet FOLLOW_INT_in_collocQuery222 = new BitSet(new long[]{0x0000200000000008L});
    public static final BitSet FOLLOW_45_in_collocQuery227 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_EXCLUSION_in_exclusionQuery254 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_term_in_exclusionQuery258 = new BitSet(new long[]{0x0000000002F74000L});
    public static final BitSet FOLLOW_term_in_exclusionQuery262 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_ADJACENCY_in_adjacencyQuery289 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_term_in_adjacencyQuery293 = new BitSet(new long[]{0x0000000002F74000L});
    ...
    public static final BitSet FOLLOW_phrase_in_tagQuery466 = new BitSet(new long[]{0x0000000040000008L});
    public static final BitSet FOLLOW_TAG_MATCH_MODE_in_tagQuery470 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_PROPERTY_in_propertyQuery496 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_phrase_in_propertyQuery500 = new BitSet(new long[]{0x0000000040010008L});
    public static final BitSet FOLLOW_phrase_in_propertyQuery505 = new BitSet(new long[]{0x0000000040000008L});
    public static final BitSet FOLLOW_TAG_MATCH_MODE_in_propertyQuery511 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_TAGPROPERTY_in_propertyQuery521 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_phrase_in_propertyQuery525 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_phrase_in_propertyQuery529 = new BitSet(new long[]{0x0000000040010008L});
    public static final BitSet FOLLOW_phrase_in_propertyQuery534 = new BitSet(new long[]{0x0000000040000008L});
    public static final BitSet FOLLOW_TAG_MATCH_MODE_in_propertyQuery540 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_REG_in_regQuery566 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_phrase_in_regQuery568 = new BitSet(new long[]{0x0000080000000008L});
    public static final BitSet FOLLOW_43_in_regQuery572 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_FREQ_in_freqQuery600 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_EQUAL_in_freqQuery602 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_INT_in_freqQuery606 = new BitSet(new long[]{0x0000000000000088L});
    public static final BitSet FOLLOW_INT_in_freqQuery610 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_FREQ_in_freqQuery621 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_UNEQUAL_in_freqQuery623 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_INT_in_freqQuery625 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_SIMIL_in_similQuery653 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_phrase_in_similQuery655 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_INT_in_similQuery657 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_WILD_in_wildQuery684 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_phrase_in_wildQuery686 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_refinementExpression_in_refinement712 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_orRefinement_in_refinementExpression738 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_andRefinement_in_refinementExpression746 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ND_REFINE_in_refinementExpression755 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_refinementTerm_in_refinementExpression757 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_ORREFINE_in_orRefinement782 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_refinementTerm_in_orRefinement786 = new BitSet(new long[]{0x0000000002FAC800L});
    public static final BitSet FOLLOW_refinementTerm_in_orRefinement790 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ND_ANDREFINE_in_andRefinement820 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_refinementTerm_in_andRefinement824 = new BitSet(new long[]{0x0000000002FAC800L});
    public static final BitSet FOLLOW_refinementTerm_in_andRefinement828 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_selector_in_refinementTerm858 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_refinementExpression_in_refinementTerm866 = new BitSet(new long[]{0x0000000000000002L});
