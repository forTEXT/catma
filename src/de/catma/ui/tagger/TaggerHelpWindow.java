...
public class TaggerHelpWindow extends Window {
	...
	public TaggerHelpWindow() {
		super(Messages.getString("TaggerHelpWindow.helpTitle")); //$NON-NLS-1$
		initComponents();
	...
	private void initComponents() {
		...
		Label helpText = new Label(Messages.getString("TaggerHelpWindow.helpText"), ContentMode.HTML); //$NON-NLS-1$
