...
public class Tagsetdefinition extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = -1695512748;

	/**
	 * The singleton instance of <code>CatmaRepository.tagsetdefinition</code>
	 */
	public static final de.catma.repository.db.jooqgen.catmarepository.tables.Tagsetdefinition TAGSETDEFINITION = new de.catma.repository.db.jooqgen.catmarepository.tables.Tagsetdefinition();
	...
	public Tagsetdefinition() {
		super("tagsetdefinition", de.catma.repository.db.jooqgen.catmarepository.Catmarepository.CATMAREPOSITORY);
	}
	...
	public Tagsetdefinition(java.lang.String alias) {
		super(alias, de.catma.repository.db.jooqgen.catmarepository.Catmarepository.CATMAREPOSITORY, de.catma.repository.db.jooqgen.catmarepository.tables.Tagsetdefinition.TAGSETDEFINITION);
	}
	...
	public org.jooq.Identity<org.jooq.Record, java.lang.Integer> getIdentity() {
		return de.catma.repository.db.jooqgen.catmarepository.Keys.IDENTITY_TAGSETDEFINITION;
	}
	...
	public org.jooq.UniqueKey<org.jooq.Record> getPrimaryKey() {
		return de.catma.repository.db.jooqgen.catmarepository.Keys.KEY_TAGSETDEFINITION_PRIMARY;
	}
	...
	public java.util.List<org.jooq.UniqueKey<org.jooq.Record>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.Record>>asList(de.catma.repository.db.jooqgen.catmarepository.Keys.KEY_TAGSETDEFINITION_PRIMARY, de.catma.repository.db.jooqgen.catmarepository.Keys.KEY_TAGSETDEFINITION_UK_TSDEF_TLIB_UUID);
	}
	...
	public java.util.List<org.jooq.ForeignKey<org.jooq.Record, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.jooq.Record, ?>>asList(de.catma.repository.db.jooqgen.catmarepository.Keys.FK_TSDEF_TAGLIBRARYID);
	}
	 ...
	 */
	@Override
	public de.catma.repository.db.jooqgen.catmarepository.tables.Tagsetdefinition as(java.lang.String alias) {
		return new de.catma.repository.db.jooqgen.catmarepository.tables.Tagsetdefinition(alias);
	}
}
