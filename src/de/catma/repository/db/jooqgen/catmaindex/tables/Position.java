...
public class Position extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = -1141237760;

	/**
	 * The singleton instance of <code>CatmaIndex.position</code>
	 */
	public static final de.catma.repository.db.jooqgen.catmaindex.tables.Position POSITION = new de.catma.repository.db.jooqgen.catmaindex.tables.Position();
	 ...
	 */
	public Position() {
		super("position", de.catma.repository.db.jooqgen.catmaindex.Catmaindex.CATMAINDEX);
	}
	...
	public Position(java.lang.String alias) {
		super(alias, de.catma.repository.db.jooqgen.catmaindex.Catmaindex.CATMAINDEX, de.catma.repository.db.jooqgen.catmaindex.tables.Position.POSITION);
	}
	...
	public org.jooq.Identity<org.jooq.Record, java.lang.Integer> getIdentity() {
		return de.catma.repository.db.jooqgen.catmaindex.Keys.IDENTITY_POSITION;
	}
	...
	public org.jooq.UniqueKey<org.jooq.Record> getPrimaryKey() {
		return de.catma.repository.db.jooqgen.catmaindex.Keys.KEY_POSITION_PRIMARY;
	}
	...
	public java.util.List<org.jooq.UniqueKey<org.jooq.Record>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.Record>>asList(de.catma.repository.db.jooqgen.catmaindex.Keys.KEY_POSITION_PRIMARY);
	}
	...
	public java.util.List<org.jooq.ForeignKey<org.jooq.Record, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.jooq.Record, ?>>asList(de.catma.repository.db.jooqgen.catmaindex.Keys.FK_POSITIONTERMID);
	}
	 ...
	 */
	@Override
	public de.catma.repository.db.jooqgen.catmaindex.tables.Position as(java.lang.String alias) {
		return new de.catma.repository.db.jooqgen.catmaindex.tables.Position(alias);
	}
}
