...
public class Usermarkupcollection extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 1260358149;

	/**
	 * The singleton instance of <code>CatmaRepository.usermarkupcollection</code>
	 */
	public static final de.catma.repository.db.jooq.catmarepository.tables.Usermarkupcollection USERMARKUPCOLLECTION = new de.catma.repository.db.jooq.catmarepository.tables.Usermarkupcollection();
	...
	public Usermarkupcollection() {
		super("usermarkupcollection", de.catma.repository.db.jooq.catmarepository.Catmarepository.CATMAREPOSITORY);
	}
	...
	public Usermarkupcollection(java.lang.String alias) {
		super(alias, de.catma.repository.db.jooq.catmarepository.Catmarepository.CATMAREPOSITORY, de.catma.repository.db.jooq.catmarepository.tables.Usermarkupcollection.USERMARKUPCOLLECTION);
	}
	...
	public org.jooq.Identity<org.jooq.Record, java.lang.Integer> getIdentity() {
		return de.catma.repository.db.jooq.catmarepository.Keys.IDENTITY_USERMARKUPCOLLECTION;
	}
	...
	public org.jooq.UniqueKey<org.jooq.Record> getPrimaryKey() {
		return de.catma.repository.db.jooq.catmarepository.Keys.KEY_USERMARKUPCOLLECTION_PRIMARY;
	}
	...
	public java.util.List<org.jooq.UniqueKey<org.jooq.Record>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.Record>>asList(de.catma.repository.db.jooq.catmarepository.Keys.KEY_USERMARKUPCOLLECTION_PRIMARY);
	}
	...
	public java.util.List<org.jooq.ForeignKey<org.jooq.Record, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.jooq.Record, ?>>asList(de.catma.repository.db.jooq.catmarepository.Keys.FK_UMC_SOURCEDOCUMENTID, de.catma.repository.db.jooq.catmarepository.Keys.FK_UMC_TAGLIBRARYID);
	}
	 ...
	 */
	@Override
	public de.catma.repository.db.jooq.catmarepository.tables.Usermarkupcollection as(java.lang.String alias) {
		return new de.catma.repository.db.jooq.catmarepository.tables.Usermarkupcollection(alias);
	}
}
