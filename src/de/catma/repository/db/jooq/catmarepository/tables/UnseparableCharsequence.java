...
public class UnseparableCharsequence extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 499331380;

	/**
	 * The singleton instance of <code>CatmaRepository.unseparable_charsequence</code>
	 */
	public static final de.catma.repository.db.jooq.catmarepository.tables.UnseparableCharsequence UNSEPARABLE_CHARSEQUENCE = new de.catma.repository.db.jooq.catmarepository.tables.UnseparableCharsequence();
	...
	public UnseparableCharsequence() {
		super("unseparable_charsequence", de.catma.repository.db.jooq.catmarepository.Catmarepository.CATMAREPOSITORY);
	}
	...
	public UnseparableCharsequence(java.lang.String alias) {
		super(alias, de.catma.repository.db.jooq.catmarepository.Catmarepository.CATMAREPOSITORY, de.catma.repository.db.jooq.catmarepository.tables.UnseparableCharsequence.UNSEPARABLE_CHARSEQUENCE);
	}
	...
	public org.jooq.Identity<org.jooq.Record, java.lang.Integer> getIdentity() {
		return de.catma.repository.db.jooq.catmarepository.Keys.IDENTITY_UNSEPARABLE_CHARSEQUENCE;
	}
	...
	public org.jooq.UniqueKey<org.jooq.Record> getPrimaryKey() {
		return de.catma.repository.db.jooq.catmarepository.Keys.KEY_UNSEPARABLE_CHARSEQUENCE_PRIMARY;
	}
	...
	public java.util.List<org.jooq.UniqueKey<org.jooq.Record>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.Record>>asList(de.catma.repository.db.jooq.catmarepository.Keys.KEY_UNSEPARABLE_CHARSEQUENCE_PRIMARY);
	}
	...
	public java.util.List<org.jooq.ForeignKey<org.jooq.Record, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.jooq.Record, ?>>asList(de.catma.repository.db.jooq.catmarepository.Keys.FK_USCS_SOURCEDOCUMENTID);
	}
	 ...
	 */
	@Override
	public de.catma.repository.db.jooq.catmarepository.tables.UnseparableCharsequence as(java.lang.String alias) {
		return new de.catma.repository.db.jooq.catmarepository.tables.UnseparableCharsequence(alias);
	}
}
