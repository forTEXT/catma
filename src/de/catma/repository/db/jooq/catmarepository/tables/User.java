...
public class User extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 784775172;

	/**
	 * The singleton instance of <code>CatmaRepository.user</code>
	 */
	public static final de.catma.repository.db.jooq.catmarepository.tables.User USER = new de.catma.repository.db.jooq.catmarepository.tables.User();
	 ...
	 */
	public User() {
		super("user", de.catma.repository.db.jooq.catmarepository.Catmarepository.CATMAREPOSITORY);
	}
	...
	public User(java.lang.String alias) {
		super(alias, de.catma.repository.db.jooq.catmarepository.Catmarepository.CATMAREPOSITORY, de.catma.repository.db.jooq.catmarepository.tables.User.USER);
	}
	...
	public org.jooq.Identity<org.jooq.Record, java.lang.Integer> getIdentity() {
		return de.catma.repository.db.jooq.catmarepository.Keys.IDENTITY_USER;
	}
	...
	public org.jooq.UniqueKey<org.jooq.Record> getPrimaryKey() {
		return de.catma.repository.db.jooq.catmarepository.Keys.KEY_USER_PRIMARY;
	}
	...
	public java.util.List<org.jooq.UniqueKey<org.jooq.Record>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.Record>>asList(de.catma.repository.db.jooq.catmarepository.Keys.KEY_USER_PRIMARY);
	}
	 ...
	 */
	@Override
	public de.catma.repository.db.jooq.catmarepository.tables.User as(java.lang.String alias) {
		return new de.catma.repository.db.jooq.catmarepository.tables.User(alias);
	}
}
